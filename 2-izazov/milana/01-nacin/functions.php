...
/**
 * In order to remove filter from parent theme, which is loading AFTER the child theme,
 * we need to hook it to event that's happening after all themes are loaded.
 */
add_action( 'init', function() {
	remove_filter( 'the_content_more_link', 'twentytwenty_read_more_tag' );
} );
...
add_filter( 'the_content_more_link', 'twentytwenty_child_the_content_more_link', 10, 2 );
